...
- Data collection for Google Chrome Browser: We have collected 100 WF measurements for each of 100 different websites ([Website list](([[https://github.com/main/Data_Collection/website_list.txt](https://github.com/hunie-main/Data_Collection/website_list.txt)]))).
